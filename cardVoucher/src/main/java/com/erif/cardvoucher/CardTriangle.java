...
public class CardTriangle extends View {

    private Paint paint;
    private Path path;
    private float shadowRadius;

    public CardTriangle(Context context) {
        super(context);
        init(context);
    }

    public CardTriangle(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CardTriangle(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
